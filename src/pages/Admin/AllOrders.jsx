    ...
    () => [
        ...
        Cell: (props) => (
          <>
            <Tooltip label={props.row.original.title}>
              {props.row.original.title.substr(0, 20)}
            </Tooltip>
            ...
          </>
        ),
      ...
      },
      {
        ...
        Cell: (props) => (
          ...
          >
            <option value="option1">Not Process</option>
            <option value="option2">Processing</option>
            <option value="option3">Shipped</option>
            <option value="option4">Deliverd</option>
            <option value="option5">Cancel</option>
          </Select>
        ),
      },
      {
